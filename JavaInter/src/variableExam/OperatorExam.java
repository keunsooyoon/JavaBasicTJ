 ...
 * 연산자는 '연산을 수행하는 기호' +, - * , / ....
 * 
 * 연산자 연산을 수행하는 기호이며 피연산자 는 작업 대상
 ...
 * 
 * 연산자의 우선순위 
 * 일반 수학 계산 순서와 동일 하게 상식적인 선에서 해결된다., 
 ...
 *  난 그 나머지만 결과로 반환하는 연산자이다. 나머지 연산자는
 *  홀수, 짝수, 배수 검사에 엄청 아주 많이 사용된다.  
 *      
 *      
 *  등가비교 연산자 == !=
 *  
 ...
 *   
 *  문자열 비교 .equals()
 *   문자열을 비교할때는 ==를 쓰지 말고 반드시 .equals()를 사용하자. 
 *  
 *  
 *   
 */
...
//		System.out.println(1 != 0);
		...
		// quiz 1. 정수를 하나 키보드로 입력 받아 그 수가
		//         홀수 인지 짝수인지를 출력하는 프로그램을 작성
		// "입력하신 수 ??는 홀수입니다."
...
// 단항 연산자를 단독으로 사용할때는 전위 후위 차이가 없다. 
